...
const statusConfig: Record<string, { bg: string; text: string; dot: string }> = {
  ...
  reviewed: { bg: "bg-purple-50", text: "text-purple-700", dot: "bg-purple-400" },
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {candidate.linkedin_url && (
            <a
              ...
              className="inline-flex items-center gap-1.5 text-xs px-3 py-1.5 bg-blue-50 text-blue-600 rounded-full hover:bg-blue-100 transition-colors font-medium"
            >
          ...
          {candidate.github_url && (
            <a
              ...
              rel="noopener noreferrer"
              onClick={(e) => e.stopPropagation()}
              className="inline-flex items-center gap-1.5 text-xs px-3 py-1.5 bg-gray-100 text-gray-700 rounded-full hover:bg-gray-200 transition-colors font-medium"
            >
              <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
          ...
          {candidate.portfolio_url && (
            <a
              ...
              rel="noopener noreferrer"
              onClick={(e) => e.stopPropagation()}
              className="inline-flex items-center gap-1.5 text-xs px-3 py-1.5 bg-purple-50 text-purple-600 rounded-full hover:bg-purple-100 transition-colors font-medium"
            >
